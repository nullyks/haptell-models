...
- Balance-shift bottom cradle: keep the four lower saddle pads, lowered side rails, lowered clamp bosses, vertical saddle-to-rail webs, and radial shell anchor ribs so the shaft centerline and horizontal arm sweep volume stay open while the holder remains attached to the shell in the printable bottom STL.
